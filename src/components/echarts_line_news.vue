            ...
            let option = {
                tooltip: {
                    ...
                    formatter:function(params, ticket, callback) {
                        let txt = that.colorFlag ? "用电量" : "报警数";
                        let tipDate = that.lineDataNew.date[params[0].dataIndex] 
                        let value = params[0].value
                        return "<div>" +tipDate + txt + "："+value+"</div>"
                    }  //function(){}, "{a} : {c}"
                },
                xAxis: {
                    type: "category",
                                ...
                                colorStops: [
                                    {
                                        ...
                                        color: this.colorFlag
                                            ? "rgba(233,253,218,0.8)"
                                            : "rgba(252,254,224,0.8)" // 0% 处的颜色
                                    },
                                    {
                                        offset: 1,
                                        color: this.colorFlag
                                            ? "rgba(219,233,252,0.8)"
                                            : "rgba(252,225,219,0.8)" // 100% 处的颜色
                                    }
                                ],
